...
const tools = [
  ...
  {name:'figma_local_apply',description:'Apply up to 100 ordered operations to the selected Figma session: create_page, create, update, clone, delete, select. create types FRAME, RECTANGLE, ELLIPSE, TEXT, COMPONENT. Use ref on creates then $ref as nodeId/parentId. props allow name,x,y,width,height,fills,strokes,strokeWeight,cornerRadius,opacity,visible,locked,rotation,characters,fontName,fontSize,textAlignHorizontal,textAutoResize,layoutMode,itemSpacing,paddingTop,paddingBottom,paddingLeft,paddingRight,primaryAxisSizingMode,counterAxisSizingMode,primaryAxisAlignItems,counterAxisAlignItems,clipsContent. Batches stop on error and report completed operations; not atomic. Reuse requestId only for identical retries. Read before destructive edits.',inputSchema:obj({sessionId:str,requestId:str,operations:{type:'array',minItems:1,maxItems:100,items:{type:'object'}}},['sessionId','requestId','operations'])},
